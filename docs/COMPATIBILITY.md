...
| `AIAscensionSTS2GameMod` plus native runtime listener | `sts2-protocol/seeded-run-v1` | Current source/component head `46b1ac6ed4f57ae62dcd2f6694a5792fdeba95c0`; callback/route, selected-context, profile-baseline, canonical-seed, and `run_started` witness probes; criterion-to-evidence map at exact pins in [`evidence/seeded-run-criterion-evidence-map-20260917.md`](evidence/seeded-run-criterion-evidence-map-20260917.md) | Source/component evidence only; live seeded-run settlement, save isolation, exact-host/package compatibility, gameplay, and release unverified |
