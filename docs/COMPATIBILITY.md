...
| Runtime-v3 gameplay candidate | STS2 v0.107.1, commit `59260271` | Windows x86-64 | Managed/native build and package | Confirmed at source/build level; [build evidence](evidence/runtime-v3-gameplay-host-build-20260902.md); live card play and settlement unverified |
...
| `AIAscensionSTS2GameMod` plus native runtime listener | `sts2-protocol/runtime-v3-gameplay` | Rust/managed gates plus controlled disposable-host `play_card` trace | Build/package candidate confirmed; host card play, settlement, and cross-target runtime remain unverified |
