...
var instanceRef=new {instance_id="instance",run_id="run",epoch=7,entity_kind="card",entity_id="card-1"};
string wire = JsonSerializer.Serialize(new { protocol_version="game-information-query-v1", schema_digest="376845b0c86b4afcd2c79ffba753eb7e7e416f5410da26b4dae970cfee2221d9", provenance=new {artifact="sts2-protocol/game-information-query-v1",source="schemas/game-information-query-v1.schema.json",generator="hand-authored"}, correlation_id="corr", kind="query_request", capabilities=(object?)null,error=(object?)null,result=(object?)null, query=new {cursor=(string?)null,detail_level="full",projection="full",query_kind="detail",entity_kind="card",fields=new[]{"display_name"},filters=new {definition_refs=Array.Empty<object>(),display_name=(string?)null,instance_ids=Array.Empty<string>(),namespaced_ids=Array.Empty<string>()},limits=new {item_bytes=4096,page_bytes=65536,page_items=1,text_bytes=4096},binding=new {mode="live",content_manifest_id="manifest",locale="en-US",visibility_scope="player",instance_ref=instanceRef,snapshot_ref=new {snapshot_id="snap",state_generation=9,instance_ref=instanceRef}},target=new {definition_ref=new {content_manifest_id="manifest",entity_kind="card",namespaced_id="ironclad:strike",variant=(string?)null},instance_ref=instanceRef},parent_observation=new {state_generation=9,snapshot_ref=new {snapshot_id="snap",state_generation=9,instance_ref=instanceRef},instance_ref=instanceRef}}});
