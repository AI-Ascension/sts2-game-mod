...
public static partial class ModEntry
{
    ...
    private static bool HasPendingRuntimeV4ExpertRestMutation() => false;
    ...
    internal static bool HasPendingNonExpertMutation() =>
        ...
        || HasPendingCoopMutation || HasPendingRuntimeV4ExpertMutation()
        || HasPendingRuntimeV4ExpertRestMutation();

    private static (int Status, string Response) ProcessRuntimeV4ExpertRestActionWork(
        RuntimeContext context, string body) =>
        (RuntimeUnavailable, "{\"error_code\":\"runtime_v4_expert_rest_host_unavailable\"}");
