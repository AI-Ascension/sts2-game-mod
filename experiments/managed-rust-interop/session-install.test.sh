...
inspection_start=$(launcher_elapsed_seconds)
...
inspection_end=$(launcher_elapsed_seconds)
(( inspection_end - inspection_start < 3 )) || { printf 'inspection deadline not enforced\n' >&2; exit 1; }
