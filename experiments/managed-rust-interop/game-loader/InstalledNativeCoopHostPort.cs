...
internal sealed partial class InstalledNativeCoopHostPort : ICoopNativeHostPort
{
    ...
    public CoopHostObservation Observe()
    {
        ...
        string choiceCatalogFingerprint = PlayerChoiceCatalogFingerprint();
        string hostFingerprint = $"{runId}|{hostDigest}|native-checksum:{_nativeChecksumOrdinal}|"
            + $"choice-catalog:{choiceCatalogFingerprint}|{string.Join(',', rosterNativeIds)}|"
