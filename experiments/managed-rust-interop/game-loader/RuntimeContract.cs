...
public static partial class ModEntry
{
    ...
    private static (int Status, string Response) ProcessRuntimeWork(RuntimeWork work)
    {
        ...
        if (work.Kind == RuntimeRequestKindLookupBinding)
        {
        ...
        if (work.Kind == RuntimeRequestKindGameInformationQuery)
        {
            return ProcessGameInformationQueryWork(work.Context, work.Body);
        }
