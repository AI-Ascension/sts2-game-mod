...
check false '. + [{"event":"action_receipt","action_id":"unrelated","operation_id":"op-3","status":"Accepted"}]'
check false '. + [{"event":"operation_wait_completed","operation_id":"op-3"}]'
check false '. + [{"event":"unexpected_after_finish"}]'
check false '.[0:-1] + [{"event":"action_receipt","action_id":"unrelated","operation_id":"op-3","status":"Accepted"}] + [.[-1]]'
check false '.[0:-1] + [{"event":"operation_wait_completed","operation_id":"op-3"}] + [.[-1]]'
printf '%s\n' 'live-campaign-trace: 22 checks passed'
